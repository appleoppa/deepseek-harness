...
- **The starter MIME table is minimal** — it covers the Vite-emitted asset set plus the shipped PWA manifest and its install-shell icons; other extensions fall back to `application/octet-stream` until an asset class ships.
